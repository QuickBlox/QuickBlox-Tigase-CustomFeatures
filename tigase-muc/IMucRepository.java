...
public interface IMucRepository {
    ...
    //
    //
    void destroyRoom(BareJID roomJID, Element destroyElement) throws RepositoryException;
    ...
    BareJID[] getPublicVisibleRoomsIdList(Integer appID) throws RepositoryException;
    ...
    //
    //
    BareJID getRoomOwner(BareJID roomJid) throws RepositoryException;
