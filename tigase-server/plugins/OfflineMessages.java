...
public class OfflineMessages
    ...
    public static final String MESSAGE_CHAT_STATE_XMLNS = "http://jabber.org/protocol/chatstates";
    public static final String[] MESSAGE_ACTIVE = {ELEM_NAME, "active"};
    public static final String[] MESSAGE_INACTIVE = {ELEM_NAME, "inactive"};
    public static final String[] MESSAGE_GONE = {ELEM_NAME, "gone"};
    public static final String[] MESSAGE_COMPOSING = {ELEM_NAME, "composing"};
    public static final String[] MESSAGE_PAUSED = {ELEM_NAME, "paused"};
